...
object Patterns {
    ...
    val TOP_LEVEL_DOMAIN_STR = ("((aero|arpa|asia|a[cdefgilmnoqrstuwxz])"
    ...
    val TOP_LEVEL_DOMAIN = Pattern.compile(TOP_LEVEL_DOMAIN_STR)
     ...
     */
    @Deprecated("This API is deprecated. See {@link #TOP_LEVEL_DOMAIN_STR}.")
    val TOP_LEVEL_DOMAIN_STR_FOR_WEB_URL = ("(?:"
     ...
     * @hide
     */
    const val IANA_TOP_LEVEL_DOMAINS = ("(?:"
     ...
     * [.IP_ADDRESS]
     */
    private const val STRICT_DOMAIN_NAME = ("(?:" + STRICT_HOST_NAME + "|"
            + IP_ADDRESS_STRING + ")")

    /**
     * Regular expression that matches domain names without a TLD
     */
    private const val RELAXED_DOMAIN_NAME =
     ...
     */
    private const val WEB_URL_WITH_PROTOCOL = ("("
            + WORD_BOUNDARY
            + "(?:"
            + "(?:" + PROTOCOL + "(?:" + USER_INFO + ")?" + ")"
            + "(?:" + RELAXED_DOMAIN_NAME + ")?"
     ...
     * @hide
     */
    val AUTOLINK_WEB_URL = Pattern.compile(
